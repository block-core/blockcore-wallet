...
@Component({
  selector: 'app-nostr-signevent',
  templateUrl: './nostr.signevent.component.html',
  styleUrls: ['./nostr.signevent.component.css'],
})
export class ActionNostrSignEventComponent implements OnInit, OnDestroy {
  content: string;
