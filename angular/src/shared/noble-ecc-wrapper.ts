...
//   try {
//     return !!necc.ExtendedPoint.fromHex(p);
//   } catch (e) {
//     return false;
//   }
// }
...
//   const P = necc.ExtendedPoint.fromHex(p);
//   const t = normalizeScalar(tweak);
//   const Q = necc.ExtendedPoint.BASE.multiplyAndAddUnsafe(P, t, BigInt(1));
...
//     return necc.ExtendedPoint.fromHex(p).toRawBytes(defaultTrue(compressed));
//   },
...
//     throwToNull(() => {
//       const A = necc.ExtendedPoint.fromHex(a);
//       const B = necc.ExtendedPoint.fromHex(b);
