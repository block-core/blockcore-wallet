...
describe('SharedTests', () => {
  ...
  it('Validate pubkey derivation', async () => {
    ...
    const publicKeySchnorr = secp.schnorr.getPublicKey(addressNode.privateKey);

    // 82a0a538928bc72b1976c3409597b063074c4921f448fe94ea8e85e0e7a6c6c7
    const pubKey1 = secp.utils.bytesToHex(publicKeySchnorr);

    // 0282a0a538928bc72b1976c3409597b063074c4921f448fe94ea8e85e0e7a6c6c7
    const pubKey2 = secp.utils.bytesToHex(addressNodePub.publicKey);

    // 82a0a538928bc72b1976c3409597b063074c4921f448fe94ea8e85e0e7a6c6c7
    const pubKey3 = secp.utils.bytesToHex(addressNodePubSliced);

    const did = `did:is:${pubKey3}`;

    expect(`did:is:${pubKey1}`).toEqual(did);
